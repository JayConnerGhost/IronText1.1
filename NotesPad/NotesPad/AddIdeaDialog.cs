...
namespace NotesPad
{
    public class AddIdeaDialog : Form
    {
        ...
        {
            TextBox name = new TextBox() {  Width = 460, Height = 20, TabIndex = 0, TabStop = true, Multiline = false };
            TextBox description = new TextBox() { Width = 460, Height = 350, TabIndex = 0, TabStop = true, Multiline = true };
